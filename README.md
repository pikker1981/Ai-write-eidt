...
AI(ChatGPT · Claude · Gemini 등)가 쓴 한글 글을 **내용은 한 글자도 건드리지 않고** 문체 · 리듬 · 표현만 자연스러운 한국어로 되돌리는 웹앱 + Claude Code 스킬입니다.
...
# .env.local 열고 ANTHROPIC_API_KEY=sk-ant-... 입력
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/epoko77-ai/im-not-ai&env=ANTHROPIC_API_KEY&envDescription=Anthropic%20API%20Key%20(https://console.anthropic.com)&envLink=https://console.anthropic.com)

> **Vercel 환경변수** `ANTHROPIC_API_KEY` 에 Anthropic API 키를 입력하면 즉시 배포됩니다. 
